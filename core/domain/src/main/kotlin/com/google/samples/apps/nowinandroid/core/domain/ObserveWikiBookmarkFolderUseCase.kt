...
class ObserveWikiBookmarkFolderUseCase @Inject constructor(
    private val wikiBookmarkRepository: WikiBookmarkRepository,
) {
    operator fun invoke(folderId: Long): Flow<WikiBookmarkFolder?> =
        wikiBookmarkRepository.observeFolder(folderId)
}
