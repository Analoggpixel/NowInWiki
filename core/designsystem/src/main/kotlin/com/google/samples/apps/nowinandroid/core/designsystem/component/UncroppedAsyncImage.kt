...
/**
 * 该 image 的使用场景应该是这样的，即上层组件想要完整保留图片，但又不确定即将加载的图片比例，
 * 因此上层需要给图片安排好宽度或长度(必须安排好一个)，然后交由该 image 自己调整比例。
 */
@Composable
fun UncroppedAsyncImage(
    imageUrl: String,
...
//    val widthDp = expectedWidthDp ?: (expectedHeightDp?.times(aspectRatio))!!
//    val heightDp = expectedHeightDp ?: (expectedWidthDp?.div(aspectRatio))!!
